...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:os2lana_skim.root')
)
...
process.ana = cms.EDFilter("OS2LAna",
    ...
    signalType = cms.string('EvtType_MC_tZbW'),
...
process.out = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('os2lanan3_skim.root'),
...
process.p = cms.Path(process.allEvents+process.evtcleaner+process.cleanedEvents+cms.ignore(process.ana)+process.finalEvents)
...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string('os2lanan3.root')
)
