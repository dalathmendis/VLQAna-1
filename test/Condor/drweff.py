...
d_TT ='/uscms_data/d3/dmendis/80x/CMSSW_8_0_15/src/Analysis/VLQAna/test/Condor/Histo13EL3/'
...
hEff = TH1D('', 'Signal Efficiency; VLQ Mass [GeV]; efficiency (%)', 7, 650, 1350)
...
prel.DrawLatex(0.20,0.93,"Simulation")
...
ll.SetNDC(kTRUE)
ll.SetTextSize(0.05)
ll.DrawLatex(0.60,0.93, "12.9 fb^{-1}(13 TeV) (2016)");
...
c1.SaveAs(plotDir+'/'+var+'_eff_'+lep+'.pdf')
raw_input('---')
