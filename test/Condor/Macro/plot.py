...
print "Tot Bkg",  h_tot.IntegralAndError(bin1,bin2,integralError), "*****", integralError
...
for ihist in reversed(templates[0:2]):# 5 was here
    hs.Add(ihist)
...
#gPad.SetLogy()
hs.Draw("Hist")
#hs.GetXaxis().SetRangeUser(75, 105);
hs.GetXaxis().Draw()
...
for ihist in reversed(templates[2:13]): #5:8
...
ll.SetNDC(kTRUE)
ll.SetTextSize(0.05)
ll.DrawLatex(0.78,0.92, "12.9 fb^{-1} (13 TeV)");#2.2 0r 0.53
