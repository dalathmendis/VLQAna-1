...
parser.add_option('--Lumi', metavar='D', type='float', action='store',
                  default= 12900., #2263.,    2200., 538.134,
                  dest='Lumi',
...
print "set of variable ", var[6:14]
#f = TFile(plotDir+"/"+skimType+"/"+var+".root", "RECREATE")                                                                                             
...
if h_dy in templates:
    h_dy.SetName("mumu"+name+"__DY")
    h_dy.Write("")
        
#if h_diboson in templates:
            
 #   h_diboson.SetName("mumu"+name+"__VV")
  #  h_diboson.Write("")
            
if h_top in templates:                                                                                                                                                                        
        
    h_top.SetName("mumu"+name+"__Top")                                                                                                                                                               
    h_top.Write("")    


if h_tZtZ_800 in templates:

    h_tZtZ_800.SetName("mumu"+name+"__TT_tZtZ_M800")
    h_tZtZ_800.Write("")

if h_tZtH_800 in templates:

    h_tZtH_800.SetName("mumu"+name+"__TT_tZtH_M800")
    h_tZtH_800.Write("")

if h_tZbW_800 in templates:

    h_tZbW_800.SetName("mumu"+name+"__TT_tZbW_M800")
    h_tZbW_800.Write("")

if h_tZtZ_1000 in templates:

    h_tZtZ_1000.SetName("mumu"+name+"__TT_tZtZ_M1000")
    h_tZtZ_1000.Write("")

if h_tZtH_1000 in templates:

    h_tZtH_1000.SetName("mumu"+name+"__TT_tZtH_M1000")
    h_tZtH_1000.Write("")

if h_tZbW_1000 in templates:

    h_tZbW_1000.SetName("mumu"+name+"__TT_tZbW_M1000")
    h_tZbW_1000.Write("")

if h_tZtZ_1200 in templates:
        
    h_tZtZ_1200.SetName("mumu"+name+"__TT_tZtZ_M1200")
    h_tZtZ_1200.Write("")

if h_tZtH_1200 in templates:

    h_tZtH_1200.SetName("mumu"+name+"__TT_tZtH_M1200")
    h_tZtH_1200.Write("")

if h_tZbW_1200 in templates:
    
    h_tZbW_1200.SetName("mumu"+name+"__TT_tZbW_M1200")
    h_tZbW_1200.Write("")
